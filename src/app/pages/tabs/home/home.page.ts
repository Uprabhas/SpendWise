...
export class HomePage implements OnInit {
  ...
  featureConfig: SwiperOptions|any;
  features: any = [{ id: 1, color: 'tertiary', icon: 'paper-plane', name: 'Send' },];
  transactions: any = [{ id: 1, to: 'Piyush Ag.', date: '2022-05-22', amount: 5000 }];
